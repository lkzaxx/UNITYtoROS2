...
docker exec -it ros2_humble bash -c "source /opt/ros/humble/setup.bash && cd /ros2_ws && source install/setup.bash && python3 /ros2_ws/install/unity_openarm_bridge/lib/unity_bridge_py/tcp_bridge_node"
